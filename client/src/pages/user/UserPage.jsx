...
function UserPage() {
  ...
  const navLinks = [
    ...
    },
    {
      ...
      icon: <Bed />,
      path: "/product-categories/bshm",
    },
    {
      label: "T-Shirts (Washday,NSTP,Anniversary Shirts)",
      icon: <Shirt />,
      path: "/product-categories/tshirts",
    },
    {
      label:
        "Information Technology, Computer Science, Computer Engineering(BSIT,BSCS,BScPE)",
      icon: <Computer />,
      path: "/product-categories/ict",
    },
    {
      label: "Tourism Management",
      icon: <Plane />,
      path: "/product-categories/bstm",
    },
    {
      label: "Uniform And Pants",
      icon: <Shirt />,
      path: "/product-categories/unif_pants",
    },
    {
      label: "Business Administration",
      icon: <Calculator />,
      path: "/product-categories/bsba",
    },
    {
      label: "Physical Education",
      icon: <Volleyball />,
      path: "/product-categories/pe",
    },
    {
      label: "Misscellenous",
      icon: <ShoppingBasketIcon />,
      path: "/product-categories/misscellenous",
    },
    {
      label: "Arts in Communication",
      icon: <Speech />,
      path: "/product-categories/bacomm",
    },
    {
      label: "Senior High School",
      icon: <Baby />,
      path: "/product-categories/sh",
    },
    {
      label: "Limited Edition Item",
      icon: <LucideDrumstick />,
      path: "/product-categories/anniv",
    },
  ];
  const links = [
    {
      label: "Whats New",
      path: "product-categories/whats-new",
      disable: false,
    },
    {
      label: "Favorites",
      path: "product-categories/favorites",
      disable: id === undefined,
    },
  ];
  return (
    <main className="text-accent flex h-screen flex-1 flex-col gap-3 overflow-hidden bg-gradient-to-b from-[#122A42] to-[#1B408C] lg:flex-col">
      <section className="navbar h-[5rem] gap-2 rounded-2xl">
        <div className="flex gap-2 text-white">
          ...
          {links.map((link) => (
            <NavLink
              ...
              to={link.path}
              className={({ isActive }) =>
                `btn flex h-auto items-center justify-center border-0 bg-transparent text-white transition-all duration-200 hover:scale-105 hover:shadow-lg ${
                  isActive ? "bg-blue-500" : ""
                }`
              }
        ...
        <div className="flex-none space-x-5">
          <div className="dropdown dropdown-end">
            ...
            <div
              tabIndex={0}
              className="card dropdown-content card-compact bg-base-100 z-[1] mt-3 w-52 text-black shadow"
            >
          ...
          <div className="dropdown dropdown-end">
            ...
            <ul
              tabIndex={0}
              className="menu dropdown-content menu-sm rounded-box bg-base-100 z-[1] mt-3 w-52 p-2 text-black shadow"
            >
              <li>
